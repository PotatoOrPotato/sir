                ...
                return {
                    ...
                    link: function (scope, elm, attrs) {
                        ...
                        function addToast(toast, toastId) {
                            ...
                            if (toast.icon) {
                                ...
                                toast.icon = "background-size: 60px 60px;background-color: #808080;background-image: url("+toast.iconUrl+")";
                            }
                    ...
                    template: 
                        '<div id="toast-container" ng-class="[config.position, config.animation]">' + 
                            '<div ng-repeat="toaster in toasters" class="toast" ng-class="toaster.type" style="{{toaster.icon}}" ng-click="click(toaster)" ng-mouseover="stopTimer(toaster)" ng-mouseout="restartTimer(toaster)">' + 
