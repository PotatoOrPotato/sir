app.controller('PurchaseEditController', ['$scope', '$http', '$state', '$stateParams', 'toaster', 'FileUploader', function ($scope, $http, $state, $stateParams, toaster, FileUploader) {
    ...
    function loadItem() {
        ...
        $http.get($scope.app.apiUrl + "/purchase/" + $scope.sn).success(function (res) {
            if (res.status == 80200) {
    ...
    function loadCategory() {
        $http.get($scope.app.apiUrl+'/purchase/category').success(function (res) {
            if(res.status==80200){
    ...
    $scope.save = function () {
        ...
        if ($scope.sn == null || $scope.sn == '') {
            $http.post($scope.app.apiUrl + "/purchase/create", data).success(function (res) {
                if (res.status == 80200) {
            ...
            $http.put($scope.app.apiUrl + "/purchase/" + $scope.sn, data).success(function (res) {
                if (res.status == 80200) {
